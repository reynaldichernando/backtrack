  ...
  return (
    <VaulDrawer.Root open={isOpen} onOpenChange={onClose} repositionInputs={false}>
      <VaulDrawer.Portal>
        ...
        <VaulDrawer.Content className="fixed bottom-0 left-0 right-0 w-full md:max-w-lg rounded-t-xl bg-background pt-4 pl-4 pr-4 pb-safe md:pb-4 shadow-xl mx-auto z-30">
